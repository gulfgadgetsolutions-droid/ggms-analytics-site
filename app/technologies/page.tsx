    ...
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white border-2 border-cyan-400 rounded-xl p-8 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
            ...
            <a href="/#work" className="text-cyan-600 text-sm font-semibold hover:underline">
              See our case study &rarr;
            </a>
          </div>

          <div className="bg-white border border-slate-200 rounded-xl p-8 hover:shadow-lg hover:-translate-y-1 hover:border-cyan-300 transition-all duration-300">
